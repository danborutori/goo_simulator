import { FrontSide, Vector2, MeshDepthMaterial, MeshPhysicalMaterial } from "three";
import { deviceSetting, gooColor } from "../deviceSetting.js";
import { ditherShaderFunction } from "./dither.js";
function modify(material, uniforms, sdfTexture, marchingStep) {
    ...
    material.onBeforeCompile = shader => {
        ...
        ` + shader.fragmentShader.replace("void main() {", `
            ...
            `).replace("float fragCoordZ = 0.5 * vHighPrecisionZW[0] / vHighPrecisionZW[1] + 0.5;", `
